...
pred identical[w,w':Work,o,o':ORCID] {
	w.metadata.o = w'.metadata.o' && w.uids.o = w'.uids.o' && w.source = w'.source
}
...
pred IMPORTED [p:PTCris, o:ORCID] {
   ...
   all g : o.groups | 
	...
	all n : (p.notifications&Creation) | 
		some g : o.groups | g.uids.o = n.uids.p && n.metadata = preferred[g].metadata.o
...
pred EXPORTED [p:PTCris, o:ORCID] {
	...
	all e : p.exported | one w : o.groups.works | e.uids.p = w.uids.o && e.metadata = w.metadata.o && w.source = PTCRIS
	...
	all w : o.groups.works | w.source = PTCRIS => some e : p.exported | e.uids.p = w.uids.o && e.metadata = w.metadata.o
}
...
pred frame[o,o':ORCID] {
	...
	all x : o'.groups.works - source.PTCRIS | x.uids.o = x.uids.o' && x.metadata.o = x.metadata.o'
	all w : o.groups.works&source.PTCRIS, w' : o'.groups.works&source.PTCRIS |
		w.putcode = w'.putcode => w = w'
	all w : o.groups.works&source.PTCRIS, w' : o'.groups.works&source.PTCRIS |
		some w.uids.o & w'.uids.o' => (w = w' || (some w'' : o.groups.works&source.PTCRIS-w | w'' = w') || (some w'' : o'.groups.works&source.PTCRIS-w' | w'' = w)) // force updates!
	all w : o.groups.works&source.PTCRIS, w' : o'.groups.works&source.PTCRIS |
		w = w' => some w.uids.o & w'.uids.o' // only update if some shared uid
...
pred EXPORT [o,o':ORCID,p:PTCris] {
	...
	all e : p.exported | (one w : o.groups.works | e.uids.p = w.uids.o && e.metadata = w.metadata.o && w.source = PTCRIS) =>
		one w : o.groups.works&o'.groups.works | e.uids.p = w.uids.o' && e.metadata = w.metadata.o && w.source = PTCRIS
}
...
pred same_ptcris[p,p':PTCris] {
	...
	all n1 : p.notifications&Creation | some n2 : p'.notifications&Creation | n1.key = n2.key and identical[n1,n2,p,p'] && #n1.(identical_creations[p])=#n2.(identical_creations[p'])
	all n1 : p'.notifications&Creation | some n2 : p.notifications&Creation | n1.key = n2.key and identical[n1,n2,p',p] && #n1.(identical_creations[p'])=#n2.(identical_creations[p])
} 
...
// IMPORT procedure is hippocratic for EXPORTED- and IMPORTED-consistent states, modulo the keys
// assigned to creation notifications.
check hippocratic_import {
	all o:ORCID,p:PTCris,p':p.next | SYNCED[p,o] && IMPORT[o,p,p'] implies 
		same_ptcris_mod[p,p']
} for 7 but 1 ORCID, 2 PTCris, 5 Work, 5 Production, 3 Notification, 3 Group
...
check hippocratic_sync {
	all o:ORCID,o':o.next,p:PTCris,p':p.next | SYNCED[p,o] && SYNC[p,p',o,o'] implies 
		(same_orcid[o,o'] && same_ptcris_mod[p,p'])
} for 8 but 2 ORCID, 2 PTCris, 6 Work, 6 Production, 3 Notification, 3 Group

// IMPORT procedure is deterministic for EXPORTED-consistent and IMPORTED-inconsistent states, modulo
// keys assigned to new creations.
...
// EXPORT procedure is deterministic for EXPORT-inconsistent and IMPORT-consistent states, modulo
// assigned putcodes.
...
} for 7 but 1 ORCID, 2 PTCris, 6 Work, 6 Production, 4 Notification, 4 Group
...
} for 7 but 2 ORCID, 1 PTCris, 6 Work, 6 Production, 4 Notification, 4 Group
...
check export_incorrect {
	all o:ORCID,o':o.next,p:PTCris| IMPORTED[p,o] && not EXPORTED[p,o] && EXPORT[o,o',p] implies SYNCED[p,o']
} for 3 but 2 ORCID, 1 PTCris, 3 Work, 3 Production, 3 Notification, 2 Group
...
} for 8 but 2 ORCID, 2 PTCris, 6 Work, 6 Production, 4 Notification, 4 Group
...
pred S1_IMPORTED_pre[p:PTCris,o:ORCID] {
	no p.productions
	no p.notifications
	no o.groups.works
}

pred S1_IMPORTED[p:PTCris,o:ORCID] {
	no p.productions
	no p.notifications
	o.groups.works = Work0+Work1
	Work0.uids.o = DOI0+EID0 && Work0.metadata.o = Metadata0 && Work0.putcode = Putcode0 && Work0.source = Scopus &&
	Work1.uids.o = DOI0+Handle1 && Work1.metadata.o = Metadata1 && Work1.putcode = Putcode1 && Work1.source = User &&
	Work0 in _preferred[o]
}

run IMPORTED_S1 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S1_IMPORTED_pre[p,o] && S1_IMPORTED[p,o'] &&  EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p']&& SYNCED[p',o'] } 
for 16 but 2 ORCID, 2 PTCris, 3 Work

pred S2_IMPORTED_pre[p:PTCris,o:ORCID] {
...
pred S2_IMPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = DOI0+EID0+Handle1
	no p.notifications
	...
	Work0.uids.o = DOI0+EID0 && Work0.metadata.o = Metadata0 && Work0.putcode = Putcode0 && Work0.source = Scopus &&
	Work1.uids.o = DOI0+Handle1 && Work1.metadata.o = Metadata1 && Work1.putcode = Putcode1 && Work1.source = User &&
	Work2.uids.o = DOI1+Handle1 && Work2.metadata.o = Metadata1 && Work2.putcode = Putcode2 && Work2.source = Scopus &&
	Work0 in _preferred[o]
		o.groups = Group1
}

run S2_IMPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S2_IMPORTED_pre[p,o] && S2_IMPORTED[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p']&& SYNCED[p',o'] }
for 20 but 2 ORCID, 2 PTCris, 3 Work

pred S3_IMPORTED_pre[p:PTCris,o:ORCID] {
	p.productions = Production0
...
pred S3_IMPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = DOI0+EID0+Handle1+DOI1
	no p.notifications
	...
	Work1.uids.o = DOI0+Handle1 && Work1.metadata.o = Metadata1 && Work1.putcode = Putcode1 && Work1.source = User &&
	Work2.uids.o = DOI1+Handle1 && Work2.metadata.o = Metadata1 && Work2.putcode = Putcode2 && Work2.source = Scopus &&
	Work3.uids.o = DOI1 && Work3.metadata.o = Metadata1 && Work3.putcode = Putcode3 && Work3.source = User &&
	Work0 in _preferred[o]
		o.groups = Group2
}

run S3_IMPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S3_IMPORTED_pre[p,o] && S3_IMPORTED[p,o'] && EXPORTED[p,o'] && IMPORTED[p,o'] && IMPORT[o',p,p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 4 Work


pred S4_IMPORTED_pre[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = DOI0+EID0+Handle1+DOI1
	no p.notifications
	o.groups.works = Work0+Work1+Work2+Work3
...
pred S4_IMPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = DOI0+EID0+Handle1+DOI1
	no p.notifications
...
run S4_IMPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S4_IMPORTED_pre[p,o] && S4_IMPORTED[p,o'] && EXPORTED[p,o'] && IMPORTED[p,o'] && IMPORT[o',p,p'] && SYNCED[p',o'] } 
for 22 but 2 ORCID, 2 PTCris, 4 Work


pred S5_IMPORTED_pre[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = DOI0+EID0+Handle1+DOI1
	no p.notifications
	o.groups.works = Work0+Work1+Work3
...
pred S5_IMPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = DOI0+EID0+Handle1
	no p.notifications
	o.groups.works = Work0+Work1+Work3
...
run S5_IMPORTED {some o:ORCID,p:PTCris,p':p.next,p'':p'.next | 
  S5_IMPORTED_pre[p,o] && S5_IMPORTED[p',o] && EXPORTED[p',o] && not IMPORTED[p',o] && IMPORT[o,p',p''] && SYNCED[p'',o] } 
for 20 but 1 ORCID, 3 PTCris, 3 Work

pred S6_IMPORTED_pre[p:PTCris,o:ORCID] {
...
pred S6_IMPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
	no p.notifications
...
run S6_IMPORTED{some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S6_IMPORTED_pre[p,o] && S6_IMPORTED[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p'] && SYNCED[p',o'] }
for 20 but 2 ORCID, 2 PTCris, 4 Work


pred S7_IMPORTED_pre[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
...
pred S7_IMPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
	some p.notifications
...
run S7_IMPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S7_IMPORTED_pre[p,o] && S7_IMPORTED[p,o'] && EXPORTED[p,o] && EXPORTED[p,o'] && IMPORTED[p,o] && not IMPORTED[p,o'] && IMPORT[o',p,p'] && SYNCED[p',o'] }
for 20 but 2 ORCID, 2 PTCris, 4 Work


pred S8_EXPORTED_pre[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
...
pred S8_EXPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata2 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
...
run S8_EXPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S8_EXPORTED_pre[p,o] && S8_EXPORTED[p',o] && not EXPORTED[p',o] &&  IMPORTED[p',o] && EXPORT[o,o',p'] && SYNCED[p',o'] }
for 20 but 2 ORCID, 2 PTCris, 4 Work

pred S9_EXPORTED_pre[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata2 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
	p.exported = Production0
	...
	Work1.uids.o = DOI0+Handle1 && Work1.metadata.o = Metadata1 && Work1.putcode = Putcode1 && Work1.source = User &&
	Work3.uids.o = DOI1 && Work3.metadata.o = Metadata1 && Work3.putcode = Putcode3 && Work3.source = User &&
	Work4.uids.o = DOI0+EID0+Handle1 && Work4.metadata.o = Metadata2 && Work4.putcode = Putcode2 && Work4.source = PTCRIS &&	
	Work0 in _preferred[o]
}

pred S9_EXPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata2 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
	p.exported = Production0
...
run S9_EXPORTED {some o:ORCID,o':o.next,o'':o'.next,p:PTCris | 
   S9_EXPORTED_pre[p,o] && S9_EXPORTED[p,o'] && not EXPORTED[p,o'] && IMPORTED[p,o'] && EXPORT[o',o'',p] && SYNCED[p,o''] } 
for 20 but 3 ORCID, 1 PTCris, 5 Work

pred S10_EXPORTED_pre[p:PTCris,o:ORCID] {
	p.exported = Production0
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata2 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
...
pred S10_EXPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata2 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
	no p.exported 
...
run S10_EXPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S10_EXPORTED_pre[p,o] && S10_EXPORTED[p',o] && not EXPORTED[p',o] &&  IMPORTED[p',o] && EXPORT[o,o',p'] && SYNCED[p',o'] }
for 20 but 2 ORCID, 2 PTCris, 5 Work

/* requires meta-data of the ptcris to be updated */
pred S11_EXPORTED_pre[p:PTCris,o:ORCID] {
	p.exported = Production0
	p.productions = Production0+Production1
...
pred S11_EXPORTED[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata3 && Production0.uids.p = EID0+DOI0+Handle1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
	p.exported = Production0
...
run S11_EXPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  /*S11_EXPORTED_pre[p,o] &&*/ S11_EXPORTED[p',o] && not EXPORTED[p',o] &&  IMPORTED[p',o] && EXPORT[o,o',p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 5 Work

pred S12_SYNC_pre[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
...
pred S12_SYNC[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
	Production0.key = Key2 && Production0.metadata = Metadata2 && Production0.uids.p = EID0+DOI0+Handle1+DOI1
	Production1.key = Key1 && Production1.metadata = Metadata1 && Production1.uids.p = DOI1
	p.exported  = Production0
...
run S12_SYNC {some o:ORCID,o':o.next,p:PTCris,p':p.next,p'':p'.next | 
  S12_SYNC_pre[p,o] && S12_SYNC[p',o] && not EXPORTED[p',o] && IMPORTED[p',o] && EXPORT[o,o',p'] && IMPORT[o',p',p''] && SYNCED[p'',o'] } 
for 20 but 2 ORCID, 3 PTCris, 5 Work


pred S13_SYNC_pre[p:PTCris,o:ORCID] {
	...
	no p.notifications
	o.groups.works = Work0+Work1
	Work0.uids.o = DOI0 && Work0.metadata.o = Metadata3 && Work0.putcode = Putcode0 && Work0.source = PTCRIS &&
	Work1.uids.o = Handle1 && Work1.metadata.o = Metadata1 && Work1.putcode = Putcode1 && Work1.source = PTCRIS &&
	Work0 in _preferred[o]
}

pred S13_SYNC[p:PTCris,o:ORCID] {
	p.productions = Production0+Production1
...
run S13_SYNC {some o:ORCID,o':o.next,p:PTCris,p':p.next,p'':p'.next | 
  S13_SYNC_pre[p,o] && S13_SYNC[p',o] && not EXPORTED[p',o] && IMPORTED[p',o] && EXPORT[o,o',p'] && IMPORT[o',p',p''] && EXPORTED[p'',o'] && SYNCED[p'',o'] }   
for 20 but 2 ORCID, 3 PTCris, 5 Work

pred S14_EXPORTED_pre[p:PTCris,o:ORCID] {
	p.exported = Production0
	p.productions = Production0
	Production0.key = Key1 && Production0.metadata = Metadata3 && Production0.uids.p = DOI0+Handle1
	no p.notifications
	o.groups.works = Work0
	Work0.uids.o = DOI0+Handle1 && Work0.metadata.o = Metadata3 && Work0.putcode = Putcode0 && Work0.source = PTCRIS &&
	Work0 in _preferred[o]
}

pred S14_EXPORTED[p:PTCris,o:ORCID] {
	p.exported = Production0+Production1
	p.productions = Production0+Production1
...
run S14_EXPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S14_EXPORTED_pre[p,o] && S14_EXPORTED[p',o] && not IMPORTED[p',o] && not EXPORTED[p',o] && EXPORT[o,o',p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 5 Work

pred S15_IMPORTED_pre[p:PTCris,o:ORCID] {
	no p.exported
	p.productions = Production0
...
pred S15_IMPORTED[p:PTCris,o:ORCID] {
	no p.exported
	p.productions = Production0
	Production0.key = Key1 && Production0.metadata = Metadata1 && Production0.uids.p = DOI0+EID0
	no p.notifications
	o.groups.works = Work0
	Work0.uids.o = DOI0+Handle1 && Work0.metadata.o = Metadata1 && Work0.putcode = Putcode0 && Work0.source = User &&
	Work0 in _preferred[o] 
}

run S15_IMPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
	S15_IMPORTED_pre[p,o] && IMPORTED[p,o] && EXPORTED[p,o] &&
	S15_IMPORTED[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 3 Work

pred S16_IMPORTED_pre[p:PTCris,o:ORCID] {
	no p.exported
	p.productions = Production0
	Production0.key = Key1 && Production0.metadata = Metadata1 && Production0.uids.p = DOI0+EID0
	one p.notifications
...
pred S16_IMPORTED[p:PTCris,o:ORCID] {
	no p.exported
	p.productions = Production0
	Production0.key = Key1 && Production0.metadata = Metadata1 && Production0.uids.p = DOI0+EID0
	one p.notifications
	...
	Work0.uids.o = DOI0+Handle1 && Work0.metadata.o = Metadata1 && Work0.putcode = Putcode0 && Work0.source = User &&
	Work0 in _preferred[o] &&
	Work1.uids.o = EID0+Handle0 && Work1.metadata.o = Metadata3 && Work1.putcode = Putcode1 && Work1.source = Scopus &&
	Work1 in _preferred[o]
}

run S16_IMPORTED {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
	S16_IMPORTED_pre[p,o] && IMPORTED[p,o] && EXPORTED[p,o] &&
	S16_IMPORTED[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 3 Work

pred S17_SYNC_pre[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key2 && Production0.metadata = Metadata3 && Production0.uids.p = DOI0+Handle1
	p.exported = Production0
	...
	o.groups.works = Work0+Work1
	Work0.uids.o = DOI0+Handle1 && Work0.metadata.o = Metadata3 && Work0.putcode = Putcode0 && Work0.source = PTCRIS &&
	Work1.uids.o = Handle0 && Work1.metadata.o = Metadata1 && Work1.putcode = Putcode1 && Work1.source = Scopus &&
	Work0 in _preferred[o]
	Work1 in _preferred[o]
}

pred S17_SYNC[p:PTCris,o:ORCID] {
	p.productions = Production0
...
run S17_SYNC {some o:ORCID,o':o.next,p:PTCris,p':p.next,p'':p'.next | 
  S17_SYNC_pre[p,o] && S17_SYNC[p',o] && not EXPORTED[p',o] && not IMPORTED[p',o] && EXPORT[o,o',p'] && IMPORT[o',p',p''] && EXPORTED[p'',o'] && SYNCED[p'',o'] } 
for 20 but 2 ORCID, 3 PTCris, 5 Work

pred S18_EXPORT_pre[p:PTCris,o:ORCID] {
	p.productions = Production0 + Production1
	Production0.key = Key1 && Production0.metadata = Metadata3 && Production0.uids.p = DOI0+Handle1
	Production1.key = Key2 && Production1.metadata = Metadata3 && Production1.uids.p = DOI1+Handle0
	p.exported = Production0+Production1
	no p.notifications
	o.groups.works = Work0+Work1
	Work0.uids.o = DOI0+Handle1 && Work0.metadata.o = Metadata3 && Work0.putcode = Putcode0 && Work0.source = PTCRIS &&
	Work1.uids.o = DOI1+Handle0 && Work1.metadata.o = Metadata3 && Work1.putcode = Putcode1 && Work1.source = PTCRIS &&
	Work0 in _preferred[o]
	Work1 in _preferred[o]
}

pred S18_EXPORT[p:PTCris,o:ORCID] {
	p.productions = Production0 + Production1
	Production0.key = Key1 && Production0.metadata = Metadata3 && Production0.uids.p = DOI0+Handle0
	Production1.key = Key2 && Production1.metadata = Metadata3 && Production1.uids.p = DOI1+Handle1
	p.exported = Production0+Production1
	no p.notifications
	o.groups.works = Work0+Work1
	Work0.uids.o = DOI0+Handle1 && Work0.metadata.o = Metadata3 && Work0.putcode = Putcode0 && Work0.source = PTCRIS &&
...
run S18_EXPORT {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S18_EXPORT_pre[p,o] && S18_EXPORT[p',o] && not EXPORTED[p',o] && not IMPORTED[p',o] && EXPORT[o,o',p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 5 Work


pred S19_EXPORT_pre[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key1 && Production0.metadata = Metadata3 && Production0.uids.p = DOI0+Handle1
	p.exported = Production0
	no p.notifications
...
pred S19_EXPORT[p:PTCris,o:ORCID] {
	p.productions = Production0
	Production0.key = Key1 && Production0.metadata = Metadata3 && Production0.uids.p = DOI0+Handle1
	p.exported = Production0
	no p.notifications
...
run S19_EXPORT {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  S19_EXPORT_pre[p,o] && S19_EXPORT[p',o] && EXPORTED[p',o] && IMPORTED[p',o] && EXPORT[o,o',p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 5 Work

pred SYNC_S20_pre[p:PTCris,o:ORCID] {
	no p.productions 
	no p.notifications
	no o.groups.works
}

pred SYNC_S20[p:PTCris,o:ORCID] {
	no p.productions 
	no p.notifications
	no o.groups.works
}

run SYNC_S20 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  SYNC_S20_pre[p,o] && SYNC_S20[p',o] && EXPORTED[p',o] && IMPORTED[p',o] && EXPORT[o,o',p'] && SYNCED[p',o'] } 
for 20 but 2 ORCID, 2 PTCris, 5 Work
...
pred BASE0 [p:PTCris,o:ORCID] {
	...
	o.groups.works = Work0+Work1+Work2
	Work0.uids.o = DOI1 && Work0.metadata.o = Metadata2 && Work0.putcode = Putcode0 && Work0.source = Scopus 
	Work1.uids.o = DOI1+Handle1 && Work1.metadata.o = Metadata1 && Work1.putcode = Putcode2 && Work1.source = PTCRIS 
	Work2.uids.o = DOI2 && Work2.metadata.o = Metadata3 && Work2.putcode = Putcode1 && Work2.source = User 
	Work1 in _preferred[o]
}
...
pred IMPORTED_SX[p:PTCris,o:ORCID] {
	...
	no p.notifications
	o.groups.works = Work0+Work1
	Work0.uids.o = DOI2+EID1 && Work0.metadata.o = Metadata1 && Work0.putcode = Putcode0 && Work0.source = User
	Work1.uids.o = DOI1+EID0+Handle1+Handle0 && Work1.metadata.o = Metadata3 && Work1.putcode = Putcode1 && Work1.source = Scopus
}
