...
One of the features of the model is the generation of synchronization scenarios (see the [report](http://nmacedo.github.io/pubs.html#inesctec15) for the complete set).
