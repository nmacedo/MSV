...
/*====================ORCID=====================*/
abstract sig Work extends Output {
	putcode : one Putcode,
	source : one Source,
...
fact ORCID1 {
  all o : ORCID | no disj w1,w2 : o.works |
    w1.putcode = w2.putcode
}

// There cannot be two works with the same source with shared uids.
fact ORCID2 {
  all o : ORCID | all disj w1,w2 : o.works |
    w1.source = w2.source implies no (w1.uids & w2.uids)
}

// Among sets of similar works exactly one of them is the preferred one.
fact ORCID3 {
  all o : ORCID | all w : o.works |
    one o.similar[w] & o.preferred
}
...
fun similar[r: ORCID] : Work -> Work {
  	*{w1,w2 : r.works | some w1.uids & w2.uids} 
}

fun _similar[] : ORCID -> Work -> Work {
  	{r:ORCID,disj w1,w2 : r.works| w1->w2 in similar[r]}
}

// Retrieves the meta-data from the preferred Work.
fun extract[o:ORCID,ws: set Work] : Metadata {
	(ws&o.preferred).metadata
}

/*====================PTCRIS=====================*/
abstract sig Production extends Output {
  key : one Key,
  metadata : one Metadata
}
...
pred IMPORTED_general [p:PTCris, o:ORCID] {
  	o.works.uids in p.productions.uids+p.notifications.uids
}
...
pred IMPORTED [p:PTCris, o:ORCID] {
   ...
   all w : o.works | 
		some p1 : p.productions+p.notifications | similar[o,w].uids in p1.uids
  	// IMPORTED2: Every Notification contains exactly  the uids of a group of similar works.
  	all n : p.notifications | 
		some w : o.works | o.similar[w].uids = n.uids
	...
	all n : (p.notifications&Creation) | 
		some w : o.works | o.similar[w].uids = n.uids && n.metadata = extract[o,o.similar[w]]
   ...
   all n : p.notifications&Modification | 
	...
	//  affected by exactly one modification.
  	all w : o.works, p1 : p.productions | some o.similar[w].uids & p1.uids && o.similar[w].uids not in p1.uids => 
		one n : p.notifications&Modification | n.key = p1.key && n.uids = o.similar[w].uids
}

run {some p:PTCris,o:ORCID | IMPORTED[p,o]} for 5 but 1 ORCID, 1 PTCris
run {some p:PTCris,o:ORCID | EXPORTED[p,o]} for 5 but 1 ORCID, 1 PTCris
...
pred EXPORTED_general [p:PTCris, o:ORCID] {
	all e : p.exported | some w : o.works | e.uids = w.uids && e.metadata = w.metadata && w.source = PTCRIS
}
...
pred EXPORTED [p:PTCris, o:ORCID] {
	...
	all e : p.exported | one w : o.works | e.uids = w.uids && e.metadata = w.metadata && w.source = PTCRIS
	...
	all w : o.works | w.source = PTCRIS => some e : p.exported | e.uids = w.uids && e.metadata = w.metadata
}
...
pred frame[o,o':ORCID] {
	o'.works - source.PTCRIS = o.works - source.PTCRIS
	all w : o.works&source.PTCRIS, w' : o'.works&source.PTCRIS |
		w.putcode = w'.putcode => w = w'
//	all w:o.works&o'.works | w in o.preferred => w in o'.preferred
//	all w:o'.works | o'.similar[w]&o'.preferred in o.works => o'.similar[w]&o'.preferred in o.preferred
//	all w:o'.works | some o'.similar[w]&o.preferred => o'.similar[w]&o'.preferred in o'.similar[w]&o.preferred
	all w : o'.preferred | w in o.preferred or o.similar[w]&o.preferred not in o'.works
...
pred EXPORT [o,o':ORCID,p:PTCris] {
	...
	all e : p.exported | (one w : o.works | e.uids = w.uids && e.metadata = w.metadata && w.source = PTCRIS) =>
		one w : o.works&o'.works | e.uids = w.uids && e.metadata = w.metadata && w.source = PTCRIS
...
pred same_orcid[o,o':ORCID] {
	all w1 : o.works | some w2 : o'.works| identical[w1,w2] && w1.putcode = w2.putcode
	all w2 : o'.works | some w1 : o.works| identical[w1,w2] && w1.putcode = w2.putcode
	
	// Preferred must be preserved (only for hippo, for determinism may change due to deletions)
	all w1 : o.preferred | some w2: o'.preferred | identical[w1,w2] && w1.putcode = w2.putcode
	all w1 : o'.preferred | some w2: o.preferred | identical[w1,w2] && w1.putcode = w2.putcode
} 

pred same_orcid_mod[o,o':ORCID] {
	all w1 : o.works | not w1.source = PTCRIS => some w2 : o'.works| identical[w1,w2] && w1.putcode = w2.putcode
	all w2 : o'.works | not w2.source = PTCRIS => some w1 : o.works| identical[w1,w2] && w1.putcode = w2.putcode
	
	// Preferred must be preserved (only for hippo, for determinism may change due to deletions)
	all w1 : o.preferred | not w1.source = PTCRIS => some w2: o'.preferred | identical[w1,w2] && w1.putcode = w2.putcode
	all w1 : o'.preferred | not w1.source = PTCRIS => some w2: o.preferred | identical[w1,w2] && w1.putcode = w2.putcode
...
one sig DOI1, EID0, EID1, DOI0, Handle1, Handle0 extends UID {}
...
pred orcid_example[o:ORCID] {
	some  w1,w2,w3,w4,w5: o.works | 
		w1.source = PTCRIS && w1.uids = DOI1+EID1 && w1.metadata = Metadata1 &&
		w2.source = User && w2.uids = DOI1 && w2.metadata = Metadata0 &&
		w3.source = User && w3.uids = EID1 && w3.metadata = Metadata0 &&
		w4.source = Scopus  && w4.uids = DOI0+Handle1 && w4.metadata = Metadata2 &&
		w5.source = User  && w5.uids = DOI0 && w5.metadata = Metadata2
}

run orcid_example {some o:ORCID | orcid_example[o]} for 10 but 1 ORCID, 5 Work

pred orcid_example2[o:ORCID] {
	some  w1,w2,w3,w4: o.works | 
		w1.source = PTCRIS && w1.uids = DOI1+EID1 && w1.metadata = Metadata1 && w1.putcode = Putcode0 &&
		w2.source = PTCRIS && w2.uids = DOI1 && w2.metadata = Metadata0 && w2.putcode = Putcode1 &&
		w3.source = PTCRIS && w3.uids = DOI0 && w3.metadata = Metadata0 && w3.putcode = Putcode0 &&
		w4.source = Scopus  && w4.uids = DOI0+Handle1 && w4.metadata = Metadata2 && w4.putcode = Putcode1
		no preferred
}

run orcid_example2 {some o:ORCID | orcid_example2[o]} for 10 but 1 ORCID, 4 Work
...
run ptcris_example1 {some o:PTCris | ptcris_example1[o]} for 10 but 1 PTCris
...
run ptcris_example2 {some o:PTCris | ptcris_example2[o]} for 10 but 1 PTCris
...
pred IMPORTED_S1[p:PTCris,o:ORCID] {
	...
	Work0 in o.preferred
}

run IMPORTED_S1 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  IMPORTED_S1_pre[p,o] && IMPORTED_S1[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p'] } for 10 but 2 ORCID, 2 PTCris
...
run IMPORTED_S2 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  IMPORTED_S2_pre[p,o] && IMPORTED_S2[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p'] } for 20 but 2 ORCID, 2 PTCris
...
pred IMPORTED_S3[p:PTCris,o:ORCID] {
	...
	Production0.key = Key2 && Production0.metadata = Metadata0 && Production0.uids = DOI0+EID0+Handle1+DOI1
	no p.notifications
	o.works = Work0+Work1+Work2+Work3
	Work0.uids = DOI0+EID0 && Work0.metadata = Metadata0 && Work0.putcode = Putcode0 && Work0.source = Scopus &&
	Work1.uids = DOI0+Handle1 && Work1.metadata = Metadata1 && Work1.putcode = Putcode1 && Work1.source = User &&
	Work2.uids = DOI1+Handle1 && Work2.metadata = Metadata1 && Work2.putcode = Putcode2 && Work2.source = Scopus &&
...
run IMPORTED_S3 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  IMPORTED_S3_pre[p,o] && IMPORTED_S3[p,o'] && EXPORTED[p,o'] && IMPORTED[p,o'] && IMPORT[o',p,p'] } for 20 but 2 ORCID, 2 PTCris
...
run IMPORTED_S4 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  IMPORTED_S4_pre[p,o] && IMPORTED_S4[p,o'] && EXPORTED[p,o'] && IMPORTED[p,o'] && IMPORT[o',p,p'] } for 22 but 2 ORCID, 2 PTCris
...
run IMPORTED_S5 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  IMPORTED_S5_pre[p,o] && IMPORTED_S5[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p'] } for 20 but 2 ORCID, 2 PTCris
...
run IMPORTED_S6 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  IMPORTED_S6_pre[p,o] && IMPORTED_S6[p,o'] && EXPORTED[p,o'] && not IMPORTED[p,o'] && IMPORT[o',p,p'] } for 20 but 2 ORCID, 2 PTCris
...
run EXPORTED_S1 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  EXPORTED_S1_pre[p,o] && EXPORTED_S1[p',o] && not EXPORTED[p',o] &&  IMPORTED[p',o] && EXPORT[o,o',p'] } for 20 but 2 ORCID, 2 PTCris
...
run EXPORTED_S3 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  EXPORTED_S3_pre[p,o] && EXPORTED_S3[p',o] && not EXPORTED[p',o] &&  IMPORTED[p',o] && EXPORT[o,o',p'] } for 20 but 2 ORCID, 2 PTCris
...
run EXPORTED_S4 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  EXPORTED_S4[p',o] && not EXPORTED[p',o] &&  IMPORTED[p',o] && EXPORT[o,o',p'] } for 20 but 2 ORCID, 2 PTCris
...
pred SYNC_S1[p:PTCris,o:ORCID] {
	...
	Work3.uids = DOI1 && Work3.metadata = Metadata1 && Work3.putcode = Putcode3 && Work3.source = User &&
	Work4.uids = DOI0+EID0+Handle1 && Work4.metadata = Metadata2 && Work4.putcode = Putcode2 && Work4.source = PTCRIS &&	
	Work1 in o.preferred
}

run SYNC_S1 {some o:ORCID,o':o.next,p:PTCris,p':p.next | 
  SYNC_S1[p,o] && not EXPORTED[p,o] && IMPORTED[p,o] && EXPORT[o,o',p] && IMPORT[o',p,p'] } for 20 but 2 ORCID, 2 PTCris
